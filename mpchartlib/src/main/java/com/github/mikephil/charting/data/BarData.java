...
public class BarData extends BarLineScatterCandleBubbleData<IBarDataSet> {
    ...
    public BarData(ArrayList<String> xVals, ArrayList<IBarDataSet> threebardata) {
        super();
    }

    public BarData(ArrayList<String> xValues, ArrayList<BarDataSet> barDataSets, IBarDataSet... dataSets) {
        super(dataSets);
    }
