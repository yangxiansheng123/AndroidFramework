 ...
 */
public class TopRightArtForumMenu {
    private Activity mContext;
    private PopupWindow mPopupWindow;
    private RecyclerView mRecyclerView;
    private View content;

    private TRArtForumMenuAdapter mAdapter;
    ...
    public TopRightArtForumMenu(Activity context) {
    ...
    private void init() {
        ...
        mAdapter = new TRArtForumMenuAdapter(mContext, this, menuItemList, showIcon);
    }
    ...
    public TopRightArtForumMenu setHeight(int height){
    ...
    public TopRightArtForumMenu setWidth(int width){
     ...
     * @return
     */
    public TopRightArtForumMenu showIcon(boolean show){
        this.showIcon = show;
        return this;
    }
     ...
     * @return
     */
    public TopRightArtForumMenu addMenuItem(MenuItem item){
     ...
     * @return
     */
    public TopRightArtForumMenu addMenuList(List<MenuItem> list){
     ...
     * @return
     */
    public TopRightArtForumMenu dimBackground(boolean b){
     ...
     * @return
     */
    public TopRightArtForumMenu needAnimationStyle(boolean need){
     ...
     * @return
     */
    public TopRightArtForumMenu setAnimationStyle(int style){
        this.animationStyle = style;
        return this;
    }

    public TopRightArtForumMenu setOnMenuItemClickListener(OnMenuItemClickListener listener){
        mAdapter.setOnMenuItemClickListener(listener);
        return this;
    }

    public TopRightArtForumMenu showAsDropDown(View anchor){
        showAsDropDown(anchor, 0, 0);
        return this;
    }

    public TopRightArtForumMenu showAsDropDown(View anchor, int xoff, int yoff){
