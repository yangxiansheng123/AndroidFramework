 ...
 */
public class TRArtForumMenuAdapter extends RecyclerView.Adapter<TRArtForumMenuAdapter.TRMViewHolder> {
    private Context mContext;
    private List<MenuItem> menuItemList;
    private boolean showIcon;
    private TopRightArtForumMenu mTopRightMenu;
    private TopRightArtForumMenu.OnMenuItemClickListener onMenuItemClickListener;

    public TRArtForumMenuAdapter(Context context, TopRightArtForumMenu topRightMenu, List<MenuItem> menuItemList, boolean show) {
    ...
    public TRMViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.popup_art_forum_menu_list, parent, false);
    ...
    public void onBindViewHolder(TRMViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            holder.newsCount.setText(menuItem.getMessageCount());
    ...
    class TRMViewHolder extends RecyclerView.ViewHolder {
        ...
        TRMViewHolder(View itemView) {
            ...
            newsCount = (TextView) itemView.findViewById(R.id.tv_newsCount);
        }
    }

    public void setOnMenuItemClickListener(TopRightArtForumMenu.OnMenuItemClickListener listener) {
