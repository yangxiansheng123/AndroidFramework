...
import com.retrofit.wheelviewaddress.OnWheelChangedListener;
import com.retrofit.wheelviewaddress.OnWheelScrollListener;
import com.retrofit.wheelviewaddress.R;
import com.retrofit.wheelviewaddress.WheelView;
import com.retrofit.wheelviewaddress.adapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
	private LinearLayout view_address_bottom;
	...
	public ChangeAddressPopwindow(final Context context) {
		...
		//设置屏幕点击高度
		//底部如果有静态栏，往上托
		view_address_bottom = (LinearLayout) view.findViewById(R.id.view_address_bottom);
		...
		if (bottom > 0) {
			LinearLayout.LayoutParams rh = (LinearLayout.LayoutParams) view_address_bottom.getLayoutParams();
			rh.height = bottom;
			view_address_bottom.setLayoutParams(rh);
		}
