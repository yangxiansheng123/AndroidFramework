...
public class MyHomeworkAdapter extends BaseQuickAdapter<MyHomeworkBean, BaseViewHolder> {
     ...
     * @param context     上下文
     */
    public MyHomeworkAdapter(@LayoutRes int layoutResId, @Nullable List<MyHomeworkBean> data, Context context) {
