package com.example.administrator.oper.widget.slidingTab;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int DEFAULT_SELECTED_INDICATOR_COLOR = 0xe98200;
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int selectedIndicatorColor = typedArray.getColor(R.styleable.SlidingTabLayout_indicatorColorT, DEFAULT_SELECTED_INDICATOR_COLOR);
