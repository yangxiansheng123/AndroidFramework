 ...
 * 版本：1.0
 * 创建日期：2018/5/3
 * 描述：WaitForClassActivity
 */
public class WaitForClassActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_wait_for_class);
        for (int i = 0; i < 10; i++) {
        ...
        mWaitForClassAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                intent.setClass(WaitForClassActivity.this, AuditionsArrangementActivity.class);
