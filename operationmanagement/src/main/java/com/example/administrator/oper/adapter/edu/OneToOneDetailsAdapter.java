 ...
 * @author yang
 * @date 20185/4/16
 * 适配器 班级管理one To one详情
 */

public class OneToOneDetailsAdapter extends BaseQuickAdapter<ClassManagementDetailsBean, BaseViewHolder> {
     ...
     * @param context     上下文
     */
    public OneToOneDetailsAdapter(@LayoutRes int layoutResId, @Nullable List<ClassManagementDetailsBean> data, Context context) {
