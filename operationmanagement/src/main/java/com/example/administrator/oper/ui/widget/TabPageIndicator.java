...
//        messageType = Remember.getString("messageType", null);
...
//                        tab.setTextColor(i == 0 ? tabTextColorSelected : tabTextColor);
//                    }
//                    if (messageType.equals("evaluation")) {
//                        tab.setTextColor(i == 1 ? tabTextColorSelected : tabTextColor);
//                        pager.setCurrentItem(selectPosition);
//                    }
//                    if (messageType.equals("interaction")) {
//                        tab.setTextColor(i == 2 ? tabTextColorSelected : tabTextColor);
//                        pager.setCurrentItem(selectPosition);
//                    }
//                }
...
//            Log.e("shanyao", positionOffset + "");
    ...
    public void setCurrentIte(int position) {
