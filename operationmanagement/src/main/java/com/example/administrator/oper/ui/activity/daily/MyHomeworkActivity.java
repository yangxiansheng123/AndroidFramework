...
public class MyHomeworkActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_my_homework);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.img_right) {
            intent.setClass(this, CreateAJobActivity.class);
    ...
    private void initView() {
        ...
        mToolbarTitle.setText(getString(R.string.title_activity_my_homework));
        ...
        mImgRight.setOnClickListener(MyHomeworkActivity.this);
        ...
        //话题
        mHomeworkAdapter = new MyHomeworkAdapter(R.layout.activity_homework_list_pattern, listData, this);
...
//        mSwipeTarget.addItemDecoration(new DividerItemDecoration(this, 0));
        ...
        mHomeworkAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                Intent intent = new Intent();
                intent.setClass(MyHomeworkActivity.this, HomeworkDetailsActivity.class);
                startActivity(intent);
            }
        });
    }
