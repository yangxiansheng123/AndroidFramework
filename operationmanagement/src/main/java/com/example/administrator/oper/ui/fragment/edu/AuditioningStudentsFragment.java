 ...
 * 版本：1.0
 * 创建日期：2018/5/14
 * 描述：AuditioningStudentsFragment  试听学员
 */
public class AuditioningStudentsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_auditioning_students, container, false);
